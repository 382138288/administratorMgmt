...
angular.module("appModule")
    .directive("uiTree", function() {
        return {
            ...
            controller: ["$scope", "$state", "$compile", '$element', function($scope, $state, $compile, $element) {
                var confDefault = {
                    clickSelect:true,
                    multiple: false,
                    multipleType: 'none',
